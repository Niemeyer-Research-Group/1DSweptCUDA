/* 
First working Euler version committed Aug 25.
*/

//COMPILE LINE:
// nvcc -o ./bin/EulerOut Euler_Orig.cu -gencode arch=compute_35,code=sm_35 -lm -restrict -Xcompiler -fopenmp
// nvcc -o ./bin/EulerOrig Euler_Orig.cu -gencode arch=compute_35,code=sm_35 -lm -restrict -Xcompiler -fopenmp -DREAL=double -DREALtwo=double2 -DREALthree=double3 -DREALfour=double4
